...
\ex
\begingl
\gla \ipa{mE:} \ipa{a:za:\textsubbridge{d}} \ipa{a:} //
\glb {\sc 1sg} free am //
\glft {\normalfont\gurmukhifont ਮੈਂ ਆਜ਼ਾਦ ਆਂ।}\\I am free. //
\endgl
\xe

\ex
\begingl
\gla \ipa{tu:} \ipa{mer@} \ipa{\textsubbridge{d}os\textsubbridge{t}} \ipa{\ae:} //
\glb {\sc 2sg} my friend are //
\glft {\normalfont\gurmukhifont ਤੂੰ ਮੇਰਾ ਦੋਸਤ ਐਂ।}\\You are my friend. //
\endgl
\xe

\ex
\begingl
\gla \ipa{@si:} \ipa{g\super h@R} \ipa{\t{\textdyoghlig}a:\:na:} \ipa{\t{\textteshlig}a:\texthth un\textsubbridge{d}e:} \ipa{\texthth a:} //
\glb {\sc 1pl} home go.{\sc inf} want.{\sc pres.m.pl} be.{\sc pres.1pl} //
\glft {\normalfont\gurmukhifont ਅਸੀਂ ਘਰ ਜਾਣਾ ਚਾਹੁੰਦੇ ਹਾਂ।}\\We want to go home. //
\endgl
\xe

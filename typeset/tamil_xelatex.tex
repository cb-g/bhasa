...
\glft {\normalfont\tamilfont நான் சுதந்திரமாக இருக்கிறேன்.}\\I am free.
\endgl
\xe

\pex[lingstyle=custom_nlevel, labeltype=caps]
\a \begingl
{\rightcomment{\ipa{[se\textsubbridge{n}\textsubbridge{t}ami\:R]}}\ipa{ni:}}[{\sc 2sg}]
\ipa{en}[my]
\ipa{ne\textsubbridge{n}p@n}[friend]
\glft {\normalfont\tamilfont நீ என் நண்பன்.}\\You are my friend.
\endgl
\a \begingl
{\rightcomment{\ipa{[ilaNgE\textsubarch{I}jin ko\:du\textsubbridge{n}\textsubbridge{t}ami\:R]}}\ipa{ni:}}[{\sc 2sg}]
\ipa{en}[my]
\ipa{ne\textsubbridge{n}p@n}[friend]
\glft {\normalfont\tamilfont நீ என் நண்பன்.}\\You are my friend.
\endgl
\a \begingl
{\rightcomment{\ipa{[i\textsubbridge{n}\textsubbridge{d}ij\"aVin ko\:du\textsubbridge{n}\textsubbridge{t}ami\:R]}}\ipa{ni:}}[{\sc 2sg}]
\ipa{en}[my]
\ipa{sne:hit\~e}[friend]
\glft {\normalfont\tamilfont நீ என் ஸ்நேகிதே.}\\You are my friend.
\endgl
\xe

\pex[lingstyle=custom_nlevel, labeltype=caps]
\a \begingl
{\rightcomment{\ipa{[se\textsubbridge{n}\textsubbridge{t}ami\:R]}}\ipa{n\"a:Ng@\:l}}[{\sc 1pl.excl}]
\ipa{vi:\:t\:tuk:u}[home.{\sc all}]
\ipa{po:g@}[go.{\sc inf}]
\ipa{viRumbuki\:ro:m}[want.{\sc pres.1pl}]
\glft {\normalfont\tamilfont நாங்கள் வீட்டுக்கு போக விரும்புகிறோம்.}\\We want to go home.
\endgl
\a \begingl
{\rightcomment{\ipa{[ilaNgE\textsubarch{I}jin ko\:du\textsubbridge{n}\textsubbridge{t}ami\:R]}}\ipa{n\"a:Ng@\:l}}[{\sc 1pl.excl}]
\ipa{vi:\:t\:tuk:u}[home.{\sc all}]
\ipa{po:x@}[go.{\sc inf}]
\ipa{viRumbuki\:ro:m}[want.{\sc pres.1pl}]
\glft {\normalfont\tamilfont நாங்கள் வீட்டுக்கு போக விரும்புகிறோம்.}\\We want to go home.
\endgl
\a \begingl
{\rightcomment{\ipa{[i\textsubbridge{n}\textsubbridge{d}ij\"aVin ko\:du\textsubbridge{n}\textsubbridge{t}ami\:R]}}\ipa{n\"a:Ng@}}[{\sc 1pl.excl}]
\ipa{vi:\:t\:tuk:u}[home.{\sc all}]
\ipa{po:h@}[go.{\sc inf}]
\ipa{viRumburo:m}[want.{\sc pres.1pl}]
\glft {\normalfont\tamilfont நாங்க வீட்டுக்கு போக விரும்புறோம்.}\\We want to go home.
\endgl
\xe
